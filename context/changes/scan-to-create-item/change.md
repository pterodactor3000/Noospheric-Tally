...
Roadmap: `context/foundation/roadmap.md` (S-02), PRD FR-002, FR-005, FR-016. Artifacts: `research.md`, `plan.md`, `plan-brief.md`, `reviews/plan-review.md`, `reviews/impl-review-phase-1.md`, `reviews/impl-review-phase-2.md`, `reviews/impl-review-phase-3.md`. Shared `items` + `item_barcodes` + `household_inventory`. Plan review F1-F7 fixed. Verdict SOUND.
